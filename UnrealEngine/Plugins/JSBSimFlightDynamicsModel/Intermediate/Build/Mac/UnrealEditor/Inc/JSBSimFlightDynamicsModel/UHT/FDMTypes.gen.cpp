...
template<> JSBSIMFLIGHTDYNAMICSMODEL_API UScriptStruct* StaticStruct<FAircraftState>()
{
	...
	struct Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_2269860270(TEXT("/Script/JSBSimFlightDynamicsModel"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_gaganasathya_Documents_GitHub_Task8_jsbsim_UnrealEngine_Plugins_JSBSimFlightDynamicsModel_Source_JSBSimFlightDynamicsModel_Public_FDMTypes_h_Statics::EnumInfo));
